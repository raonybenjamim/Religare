...
var MenuTexts = LanguageMap{
	models.English: Texts{
		WelcomeMessage: "Welcome to Religare! This application aims to allow communication " +
		...
		SelectGenerator: "Please select one of the supported generators:\n" +
			"1- Generate using Wifi Signal (Default)\n" +
			"2- Generate using random signals\n" +
			"3- Use text input (WARNING: This is for tests only)\n",
		BypassValidation: "Should Religare validate the incomming signal?\n" +
		...
		StartMessage: "Ok! Religare will now begin!\n" +
	...
	models.Portuguese: Texts{
		WelcomeMessage: "Bem-vindo ao Religare! Este aplicativo tem como objetivo permitir a comunicação " +
		...
		SelectGenerator: "Por favor, selecione um dos geradores suportados:\n" +
		...
		BypassValidation: "O Religare deve validar o sinal recebido?\n" +
		...
		StartMessage: "Ok! O Religare começará agora!\n" +
